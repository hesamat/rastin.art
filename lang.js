...
const translations = {
    fa: {
        ...
        classes: {
            ...
            btn: "ثبت‌نام در کلاس",
            beginner: {
                title: "کلاس تار مبتدی",
                level: "سطح مبتدی",
                desc: "آشنایی با ساز تار، اصول نوازندگی و فراگیری ردیف‌های ابتدایی",
                feature1: "آشنایی با ساز و نت‌نویسی",
                feature2: "ردیف دشتی و شور",
                feature3: "تمرینات عملی"
            },
            advanced: {
                title: "کلاس تار پیشرفته",
                level: "سطح پیشرفته",
                desc: "تکنیک‌های پیشرفته نوازندگی تار و تحلیل عمیق ردیف‌های دستگاهی",
                feature1: "ردیف‌های کامل دستگاه‌ها",
                feature2: "تصانیف و چهارمضراب‌ها",
                feature3: "بداهه‌نوازی"
            },
            vocal: {
                title: "کلاس آواز ایرانی",
                level: "سطح مبتدی تا پیشرفته",
                desc: "آموزش اصول خوانندگی ایرانی و فراگیری ردیف آوازی",
                feature1: "تکنیک‌های تنفسی",
                feature2: "ردیف آوازی قدیم",
                feature3: "تصانیف خوانی"
            }
        },
        events: {
            title: "برنامه‌ها",
        ...
        quote: {
            text: "موسیقی، زبان روح است و ردیف، گنجینه‌ی هزارساله‌ی فرهنگ ماست. وظیفه‌ی ما نه فقط نواختن، که درک و انتقال این میراث گران‌بها به نسل‌های آینده است. هر زخمه بر تار، باید روایتی از عشق، تاریخ و حکمت این سرزمین باشد.",
